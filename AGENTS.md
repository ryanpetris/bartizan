# Instructions for agents working on Bartizan
...
- Before Bartizan v1.0.0, do not add migrations, compatibility layers, legacy fallbacks, or
...
- Keep these versions at their initial values until Bartizan v1. At v1, prompt the user to remove
