...
export const settings: [path: string, label: string, section: SectionId][] = [
  ...
  ['terminal.font', 'Font', 'terminal'], ['terminal.font_size', 'Font Size', 'terminal'], ['terminal.ligatures', 'Ligatures', 'terminal'], ['terminal.webgl', 'WebGL Rendering', 'terminal'], ['terminal.scrollback', 'Scrollback', 'terminal'],
...
export const labels: Record<string, Record<string, string>> = {
  ...
  'terminal.webgl': { true: 'Enabled', false: 'Disabled' },
