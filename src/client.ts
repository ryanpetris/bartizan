...
return {
  ...
  newApplication: (id, application) => call('new-application', id, application),
  retryApplication: id => call('retry-application', id),
  respondApplication: (id, consentId, accepted) => call('respond-application', id, consentId, accepted),
