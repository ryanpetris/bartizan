...
const fields = ['label', 'host', 'username', 'port', 'auth.method', 'auth.identity_files', 'auth.agent', 'auth.password', 'auth.passphrase', 'host_keys.policy', 'host_keys.fingerprints', 'terminal.scrollback', 'terminal.font', 'terminal.font_size', 'terminal.ligatures', 'ssh.ConnectTimeout', 'ssh.ServerAliveInterval', 'ssh.ServerAliveCountMax', 'ssh.ForwardAgent', 'ssh.Compression', 'ssh.TCPKeepAlive', 'ssh.AddressFamily', 'ssh.LogLevel', 'ssh.KexAlgorithms', 'ssh.Ciphers', 'ssh.MACs', 'ssh.HostKeyAlgorithms', 'ssh.PubkeyAcceptedAlgorithms'] as const;
